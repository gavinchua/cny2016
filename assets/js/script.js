...
/*	=============================================================================
	...
	/*	--------------------------------------------------
		...
		function setDimensionFN() {
			...
			$( '.home .main, .zodiac-wrapper .main, .zodiac-loading-wrapper, .zodiac-content .scene' ).css( 'height', windowHeightFN() );
		...
		function indexPageFN() {
			...
			$( '.zodiac a' ).click(function(e){
				...
				setTimeout(function() {
					...
					$( '.' + rel + '-wrapper' ).removeClass( 'hide-only' );
			...
			$( '.btn-home' ).click(function(e){
				...
				setTimeout(function() {
					...
					$( '.zodiac-wrapper' ).addClass( 'hide-only' );
	...
	/*	--------------------------------------------------
		...
		function setTopFN() {
			...
			if ( scrolledVal === 0 ) {
				setTimeout(function() {
					$( '.zodiac-wrapper .scene1' ).css( 'top', 0 );
				}, 100);
			}
		}
